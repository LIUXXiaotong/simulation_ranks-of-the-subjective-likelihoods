...
a1_coh_two
afex_plot(a1_coh_two, "combination_of_two", "condition", "event_topic") ###  the interaction condition:combination_of_two:event_topic is significant
...
dt2$marginal_order <- ifelse (dt2$order == "marginal_disjunction_conjunction" | dt2$order ==  "marginal_conjunction_disjunction" , "first", 
                          ifelse(dt2$order == "disjunction_marginal_conjunction" | dt2$order ==  "conjunction_marginal_disjunction" | dt2$order == "disjunction_conjunction_marginal" | dt2$order ==  "conjunction_disjunction_marginal", "latter",
                                        "NA"))
