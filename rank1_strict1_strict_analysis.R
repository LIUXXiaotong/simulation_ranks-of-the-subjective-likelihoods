...
table_marg_conj_agg <- dcast(data=rank1_strict1_strict_marg_conj,
...
rank1_strict1_strict_table_marg_conj <- rbind(table_marg_conj_1, table_marg_conj_2, table_marg_conj_3, table_marg_conj_4,
